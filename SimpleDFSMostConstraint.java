...
public class SimpleDFSMostConstraint {
	...
	public SimpleDFSMostConstraint(Store s) {
		store = s;
	}
	...
	public class ChoicePoint {
		...
		IntVar selectVariable(IntVar[] v) {
			int indexOflargestDifference = 0;
			...
			if (v.length != 0) {
				...
				return v[indexOflargestDifference];
			} else {
